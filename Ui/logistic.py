...
from models import logistic_cardio
import pandas as pd
import requests
# Function implementation
features, scaler, model, Y_pred, cr, cm = logistic_cardio()

st.header('Cardiovascular Disease Prediction')
st.subheader('Using Logistic Regression')

API_URL = 'https://cardiovascular-predict-system.onrender.com/request-logistic-cardio'
...
ap_lo = st.sidebar.slider(
    'Di-Systolic Pressure', min_value=50, max_value=90, value=80, step=1
)
